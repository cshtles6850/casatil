...
export default function HomePage() {
  const heroPricing = homeHeroPricing('en');
  const serviceSchema = {
  ...
  return <main className="has-booking-cta">
    ...
    <section className="home-hero"><div className="container hero-grid">
      <div className="hero-visual" aria-label="Cappadocia airport shuttle vehicles">
        <Image src="/cappadocia-airport-shuttle-vito-sprinter.webp" alt="Cappadocia Airport Shuttle Mercedes Vito and Sprinter vehicles" width={1200} height={675} priority fetchPriority="high" quality={60} sizes="(max-width: 560px) calc(100vw - 22px), (max-width: 708px) calc(100vw - 28px), (max-width: 820px) 680px, (max-width: 1216px) 48vw, 590px" />
      </div>
