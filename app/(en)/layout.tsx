...
export const metadata: Metadata = {
  ...
  title: { default: 'Cappadocia Airport Shuttle | Kayseri & Nevsehir €15', template: '%s | Cappadocia Airport Shuttle' },
  ...
  keywords: ['cappadocia airport shuttle','cappadocia shuttle transfer','cappadocia airport transfer','kayseri airport shuttle','nevsehir airport shuttle'],
