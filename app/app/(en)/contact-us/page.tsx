...
export default function ContactUsPage(){return <main>
  ...
  <section className="section page-content-section"><div className="container contact-grid">
    ...
    <aside className="contact-aside">
      <div className="summary-box"><h3>Direct contact</h3><div className="contact-method"><span>Email</span><a href={`mailto:${SITE.email}`}>{SITE.email}</a></div><div className="contact-method"><span>WhatsApp</span><a href={`https://wa.me/${SITE.whatsappDigits}?text=${whatsappMessage}`} target="_blank" rel="noreferrer"><WhatsAppIcon size={18}/> {SITE.whatsappDisplay}</a></div></div>
      <div className="summary-box"><h3>Before you write</h3><p className="small-copy">For a booking question, include the airport (ASR or NAV), flight code, hotel town, travel date and passenger count if you already know them. Do not send payment-card information.</p></div>
