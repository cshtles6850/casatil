...
export const metadata: Metadata = {
  ...
  description:'说明 Cappadocia Airport Shuttle 在预订、联系表单和机场接送运营中如何处理乘客与联系资料。',
...
export default function PrivacyPolicyZh(){return <main lang="zh-CN">
  ...
  <section className="section page-content-section"><div className="container privacy-prose prose">
    ...
    <section className="content-section"><h2>资料用途</h2><p>资料用于处理和确认预订、安排拼车或私人接送、协调机场会合与酒店上下客、处理航班或订单变化、回复 Contact Us 留言、保障网站安全以及履行适用的运营或法律要求。</p></section>
    ...
    <section className="content-section"><h2>预订与护照信息</h2><p>如果预订运营或适用规定要求乘客/护照资料，这些资料只用于相关接送和必要合规用途，不用于广告，也不会出售给第三方。</p></section>
    <section className="content-section"><h2>联系表单</h2><p>Contact Us 表单可收集姓名、邮箱、WhatsApp/电话、主题和留言，信息只用于回复咨询和提供相关预订或客服帮助。</p></section>
