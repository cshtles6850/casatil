...
export default function ServiceContractZh(){return <main lang="zh-CN">
  ...
  <section className="section page-content-section"><div className="container privacy-prose prose">
    ...
    <section className="content-section"><h2>2. 服务范围</h2><p>本合同适用于通过本站预订的共享机场班车和私人机场接送，服务连接开塞利机场（ASR）、内夫谢希尔机场（NAV）与支持的卡帕多奇亚住宿区域。</p></section>
    ...
    <section className="content-section"><h2>5. 取消与修改</h2><p>需要取消或修改时，应尽早通知。航班、机场、酒店、日期、人数或联系方式发生变化，应尽可能在接送前更新。</p><p>由于标准方式是上车后现金支付，一般订单通常没有预付款需要退款。如果个别预订另行约定预付款，对应取消条件会单独说明。</p></section>
    ...
    <section className="content-section"><h2>7. 酒店道路</h2><p>部分洞穴酒店、历史住宿和村路狭窄、陡峭，或不适合大型车辆在门口等待。如果无法安全直达，会按该笔预订确认附近可通车的上下客位置。</p></section>
    ...
    <section className="content-section"><h2>9. 乘客资料责任</h2><p>客户负责确保姓名、运营需要时提供的护照资料、航班、酒店和联系方式准确。代他人预订的人确认自己有权提供同一订单乘客所需资料。</p></section>
    <section className="content-section"><h2>10. 延误与不可合理控制情况</h2><p>交通、封路、天气、车辆故障、机场限制、安全措施、航班异常或其他不可合理控制情况可能影响服务。可行时会安排合适替代车辆或更新运营方案。如果因服务提供方可归责原因导致已付款服务完全无法执行，未执行部分已付款项将退还。</p></section>
