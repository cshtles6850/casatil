...
export default function ChineseHomePage() {
  ...
  return <main lang="zh-CN" className="has-booking-cta">
    ...
    <section className="home-hero"><div className="container hero-grid">
      <div className="hero-visual" aria-label="卡帕多奇亚机场接送车辆"><Image src="/cappadocia-airport-shuttle-vito-sprinter.webp" alt="卡帕多奇亚机场接送 Mercedes Vito 和 Sprinter" width={1200} height={675} priority fetchPriority="high" quality={60} sizes="(max-width: 800px) 94vw, 48vw" /></div>
