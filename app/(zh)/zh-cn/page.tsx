...
export const metadata: Metadata = {
  ...
  description: '卡帕多奇亚机场接送：从开塞利 ASR 或内夫谢希尔 NAV 前往格雷梅、于尔居普、乌奇希萨尔、阿瓦诺斯、奥塔西萨和恰武辛。可选共享班车和私人 Vito/Sprinter，并通过 WhatsApp 预订。',
  alternates: { canonical: '/zh-cn', languages: { en: '/', 'zh-CN': '/zh-cn', es:'/es', 'pt-BR':'/pt-br', ko:'/ko', ja:'/ja', 'x-default': '/' } },
  openGraph: { type: 'website', locale: 'zh_CN', title: '卡帕多奇亚机场接送｜ASR / NAV 机场班车', description: 'ASR / NAV 到卡帕多奇亚酒店，可选共享班车和私人 Vito/Sprinter 接送。', url: `${SITE.domain}/zh-cn`, images: [{ url: '/cappadocia-airport-shuttle-vito-sprinter.webp', width: 1200, height: 675, alt: '卡帕多奇亚机场接送 Vito 与 Sprinter' }] },
...
export default function ChineseHomePage() {
  const heroPricing = homeHeroPricing('zh-CN');
  const serviceSchema = {
  ...
  return <main lang="zh-CN" className="has-booking-cta">
    ...
    <section className="home-hero"><div className="container hero-grid">
      <div className="hero-visual" aria-label="卡帕多奇亚机场接送车辆"><Image src="/cappadocia-airport-shuttle-vito-sprinter.webp" alt="卡帕多奇亚机场接送 Mercedes Vito 和 Sprinter" width={1200} height={675} priority fetchPriority="high" quality={60} sizes="(max-width: 560px) calc(100vw - 22px), (max-width: 708px) calc(100vw - 28px), (max-width: 820px) 680px, (max-width: 1216px) 48vw, 590px" /></div>
    ...
    <section className="section section-muted"><div className="container">
      ...
      <div className="cards trust-cards">
        ...
        <div className="card"><h3>拼车或私人车</h3><p>共享拼车价格按机场分别设置；需要直达或指定 Vito/Sprinter 时选择私人接送。</p></div>
