...
export const metadata: Metadata = {
  ...
  description: '卡帕多奇亚机场接送：开塞利机场 ASR 与内夫谢希尔机场 NAV 到格雷梅、于尔居普、乌奇希萨尔、阿瓦诺斯、奥塔西萨和恰武辛。可选共享班车和私人 Vito/Sprinter。',
...
export default function ChineseRootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  ...
  return <html lang="zh-CN"><head><script src="https://analytics.ahrefs.com/analytics.js" data-key="JtSCb+u8cD998Q5+cUfyTg" async /></head><body><JsonLd data={org} /><HeaderZh />{children}<FooterZh /></body></html>;
}
