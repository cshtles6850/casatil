...
const townProfiles = {
  ...
  "urgup": {
    ...
    "hotels": [
      ...
      "MDC Hotel",
      "Canyon Cave Hotel",
      "Emin Koçak Termal Spa & Convention Center",
      "Hasse Cave Konak",
      "Elif Stone House",
      "Elysion Cave Suites",
      "Cappadocia Cave House",
      "Zeydem Suites - Luxury Cave Cappadocia",
      "Elevres Stone House Otel",
      "Kemerhan Cave Suites",
      "Dere Suites",
      "The Red Horse Hotel",
      "Eka Cave Maison",
      "Lavinia Cappadocia Cave Suit",
      "Taru Cave Suites",
      "Gul Konaklari Sinasos",
      "Dede Cave Konak",
      "Tafana Cave & Stone Lodge Hotel",
      "Golden Cave Suites",
      "Melekler Evi Cave Hotel",
      "Yusuf Yigitoglu Mansion",
      "Cappadocia Palace Hotel",
      "Asia Minor Hotel Cappadocia",
      "Buyuk Sinasos Konagi",
  ...
  "uchisar": {
    ...
    "hotels": [
      ...
      "Selfie Cave Hotel Cappadocia",
      "Ariana Sustainable Luxury Lodge",
      "Woox Cappadocia Hotel",
      "Rox Cappadocia",
      "Breeze Of Cappadocia",
      "The Kingdom Of Cappadocia Luxury Cave Hotel",
      "Caldera Hotel",
      "Karlık Cave Suites",
      "Wings Cappadocia Hotel",
      "Cappadocia Bloom Hotel",
      "Karlik Evi Boutique Hotel",
      "Cappadocia Cave Resort & Spa",
      "Eyes Of Cappadocia Cave Hotel",
      "Via Regia Cappadocia Hotel",
      "Louis Cappadocia",
      "Alice in Cappadocia",
      "Maiya Hotel",
      "Cappadocia Pegasos Cave Suite Hotel",
      "Pigeon Hotel",
      "Helike Cave Hotel",
      "Flavia Cappadocia Hotel",
      "Kale Konak Cave Hotel",
      "Leda Stone House",
      "Elite Rose Cappadocia",
      "incebey Konak Cappadocia",
      "Les Maisons De Cappadoce",
      "Wish Cappadocia",
      "Maze Of Cappadocia",
      "Taskonaklar Hotel Cappadocia",
      "Uchisar Kaya Hotel",
      "Drala Inn Cappadocia",
      "Hermes Cave Hotel",
      "Maya Cave Hotel",
      "Kapadokya Konak Hotel",
  ...
  "avanos": {
    ...
    "hotels": [
      ...
      "Ipekyolu Garden",
      "Begam Butik Otel",
      "Zuwinasa House Hotel",
      "Bayer Stone House",
      "Hacı Aşık Konağı Butik Hotel",
      "DAPHNE CAVE Cappadocia",
      "Route Cappadocia",
      "Gülbaba Hotels - Avanos",
      "Selebrity Cappadocia",
      "Aleria Cappadocia Hotel"
    ],
  ...
  "ortahisar": {
    ...
    "hotels": [
      ...
      "Cappadocia Vita Cave Hotel",
      "Exedra Hotel",
      "Vie Cappadocia - Adults Only",
      "Doda Artisanal Cave Hotel +14",
      "Ramada by Wyndham Cappadocia",
      "Seyrah Hotel",
      "Abu Hayat Cave Suites",
      "Turkish Cave House",
      "Hezen Cave Hotel",
      "Tafoni Houses Cave Hotel",
      "Capp Royal Cave Hotel",
      "Casia Cave Suites",
      "Minia Cave Hotel Ortahisar",
      "Potamia Cave Suites",
      "Eagle Cave Inn",
      "Fosil Cave Hotel",
      "Farmer Cave House",
      "Oba Cave Hotel",
      "Cappadocia Sweet Cave",
      "Castle Inn",
      "Acer Cave Hotel",
      "Nova Cave Hotel",
      "Asyada Suites Hotel",
      "Alba Cave Cappadocia",
      "Mahzen Cave Hotel",
      "Luna Cave Hotel",
      "Lamihan Cave Hotel",
      "Carna Cave Hotel",
      "Dilek Kaya",
      "Hush Cappadocia Hotel",
      "Library Cave Hotel",
      "Vigneron Cave Hotel",
      "Anitya Cave House",
      "Cappadocia Pema Cave Hotel",
  ...
  "cavusin": {
    ...
    "hotels": [
      ...
      "Hereni Butik Hotel",
      "Fairyland Cave Hotel",
      "Bellapais Suites Cappadocia",
      "Marvel Of Cappadocia",
      "Suleyman Cappadocia Hotel",
      "Katapa Special Cave",
      "Cappadocia Suleyman Hotel",
      "In Stone House",
      "Milagre Cave Hotel",
      "Bala Cave House",
      "Sara Cave Cappadocia",
      ...
      "Mesken Cave Suites",
      "Rose Valley Hotel",
      "Cappadocia Hürrem Sultan Konağı",
      "Tombak Cappadocia Hotel",
      "Cappadocia Cavusin Stone House",
      "Asgard Cave Cappadocia",
      "Çavuşin Cave House",
      "Route Cappadocia",
      "Pandora Cave Hotel"
    ],
...
const routeLocalArrival: Record<string, { heading: string; paragraphs: string[] }> = {
  "kayseri-goreme": { heading: "A practical first evening after the longer Kayseri\u2013Goreme road", paragraphs: ["After an ASR arrival, Goreme is usually the point where the travel day finally slows down. If daylight remains, keep the first outing close to town: the central streets and a nearby viewpoint are easier to fit around check-in than a valley hike. Goreme Open Air Museum deserves a proper visit rather than a rushed stop with luggage or after a delayed flight.", "If the next morning is reserved for balloons, remember that activity begins before sunrise. A late airport arrival followed by an ambitious evening often makes the first Cappadocia morning harder than it needs to be, so the transfer page treats rest and realistic timing as part of the arrival plan."] },
  "nevsehir-goreme": { heading: "What the shorter NAV\u2013Goreme transfer can give you on arrival day", paragraphs: ["NAV is closer to Goreme by road, so an on-time daytime arrival can leave useful time after check-in. That extra time is best spent locally\u2014central Goreme, a terrace or a short viewpoint visit\u2014rather than assuming the shorter airport road guarantees enough time for a full valley route.", "For travelers staying on the upper cave-hotel slopes, the last part of the journey can still be slower than the regional road suggests. The advantage of NAV is the shorter intercity segment; the hotel approach remains specific to the property."] },
  "kayseri-urgup": { heading: "Arriving in Urgup from Kayseri: town atmosphere before sightseeing", paragraphs: ["Urgup is easy to settle into after the longer ASR drive because restaurants, shops and the old center are close enough for a simple evening. Temenni Hill and the historic streets make more sense as flexible first-day options than trying to add a distant tour immediately after a flight.", "The Three Beauties viewpoint is one of the best-known landmarks associated with Urgup, but it should be planned as a separate local stop rather than assumed to be part of an airport transfer. A transfer booking is point-to-point unless an additional stop is explicitly confirmed."] },
  "nevsehir-urgup": { heading: "NAV to Urgup is shorter than ASR, but Urgup is still its own destination", paragraphs: ["A NAV arrival reaches Urgup without the longer Kayseri road, yet the final hotel approach can range from normal town streets to older stone quarters. This is why \u201cCappadocia hotel\u201d is not enough information for the transfer team: Urgup needs to be identified as the real destination.", "If arrival is early, use the center, Temenni Hill or a relaxed meal as the first activity. Save the Three Beauties and wider Cappadocia touring for a time when the flight and hotel check-in no longer control the schedule."] },
  "kayseri-uchisar": { heading: "The first view of Uchisar is also a reminder that the town sits high", paragraphs: ["Coming from ASR, the long regional drive ends with a climb into Uchisar\u2019s elevated hotel zone. Uchisar Castle dominates the town and many terraces take advantage of the same height, which is excellent for views but relevant to luggage and vehicle access.", "Pigeon Valley links the Uchisar and Goreme landscape, but it is not a sensible \u201cquick walk\u201d to squeeze between airport arrival and hotel check-in. On arrival day, use the castle area and nearby viewpoints if you want something short and easy to abandon if the flight runs late."] },
  "nevsehir-uchisar": { heading: "A short NAV road can put you in Uchisar early\u2014use that time carefully", paragraphs: ["NAV is the closer airport for Uchisar by the published road figures. On a smooth daytime arrival, that can leave enough time for the castle area or a nearby viewpoint after check-in. It does not remove the need to find the correct hillside hotel and reachable stopping point first.", "Pigeon Valley is a major local landscape connection, but hiking plans should start after luggage is settled and daylight is checked. The airport transfer should finish the travel day cleanly rather than become the first stage of a rushed hike."] },
  "kayseri-avanos": { heading: "The Kizilirmak gives Avanos a very different arrival rhythm", paragraphs: ["Avanos feels different from the cave-hotel slopes of Goreme and Uchisar. The Kizilirmak runs through town, and the local pottery tradition is closely tied to the river\u2019s red clay. After the ASR drive, a riverside walk or a pottery workshop area is a more natural first activity than immediately transferring again to another Cappadocia town.", "Pottery in Avanos is not a decorative SEO detail: it is part of the town\u2019s long craft identity, with the tradition commonly traced back through Anatolian history to Hittite-era practice. The exact workshop you visit is a personal choice, so the airport transfer does not bundle a commercial pottery stop unless separately arranged."] },
  "nevsehir-avanos": { heading: "Arriving from NAV: first identify which side of Avanos you are staying on", paragraphs: ["The NAV road to Avanos is relatively short, but the town stretches along both sides of the Kizilirmak. Once the vehicle reaches Avanos, the correct hotel name and river-side location matter more than the remaining regional distance.", "If you have spare daylight after check-in, the riverfront and pottery quarters are easy local choices. They also keep you close to the hotel if luggage, room readiness or a delayed arrival changes the plan."] },
  "kayseri-ortahisar": { heading: "Ortahisar rewards a slower arrival after the Kayseri drive", paragraphs: ["After the ASR road, Ortahisar offers a quieter arrival than the busiest parts of central Cappadocia. The rock castle rises directly above the settlement and the surrounding stone streets are compact enough for an unhurried first walk after check-in.", "Do not confuse the calm village atmosphere with identical vehicle access everywhere. Historic lanes around the castle can still determine where a larger shuttle can stop, which is why the real hotel name remains essential even in a smaller town."] },
  "nevsehir-ortahisar": { heading: "NAV to Ortahisar: use the shorter airport side for a calm first day", paragraphs: ["A NAV arrival usually leaves less road between the airport and Ortahisar than an ASR arrival. If the flight is on time, that can make the castle area and village streets realistic first-day options without committing to a long excursion.", "Ortahisar\u2019s appeal is its local scale and stone-built setting. The transfer should end at the correct accommodation or safe meeting point first; nearby valleys and wider touring are better planned after the hotel has been reached and luggage is settled."] },
  "kayseri-cavusin": { heading: "Cavusin is small, but its valley setting gives an arrival more context", paragraphs: ["The ASR drive ends near a village that sits beside some of Cappadocia\u2019s best-known walking country. Rose Valley and Red Valley connections are close, and the old village around the Church of St John the Baptist gives Cavusin a character that is very different from simply calling it \u201cnear Goreme\u201d.", "That does not mean a traveler should start a valley walk as soon as the airport vehicle arrives. First reach the exact hotel, leave luggage and check daylight. Trail time is difficult to predict if a flight or shared shuttle has already run later than planned."] },
  "nevsehir-cavusin": { heading: "A NAV arrival reaches Cavusin quickly, but the village deserves its own plan", paragraphs: ["NAV keeps the regional road relatively short, yet Cavusin\u2019s final approach still includes village lanes, valley access and early-morning balloon activity. Treating it as a Goreme stop can create confusion when the hotel is actually on a different village road.", "After check-in, the old village and nearby valley scenery can be explored without turning arrival day into a full trek. Red and Rose Valley are particularly associated with sunset landscapes, but enough daylight and a safe return route should come before trying to fit them into a delayed travel day."] },
};

const routeLocalReturn: Record<string, { heading: string; paragraphs: string[] }> = {
  "kayseri-goreme": { heading: "Last hours in Goreme before a Kayseri flight", paragraphs: ["For a late ASR departure, keep the final hours around central Goreme, your terrace or an easy viewpoint rather than starting a valley hike. The longer airport road means a late return from an activity can erase the margin you need before the flight.", "If balloon flights operated that morning, traffic and hotel activity can be busy around sunrise. Have luggage ready before the confirmed collection window instead of assuming a vehicle can wait on a narrow cave-hotel lane."] },
  "nevsehir-goreme": { heading: "A shorter NAV departure does not make Sunset Point a last-minute stop", paragraphs: ["Goreme\u2019s nearby viewpoints are tempting before a late flight, but the sensible final activity is one you can end immediately. Return to the hotel or confirmed meeting point before the shuttle window; the short NAV road is not a reason to make the collection itself tight.", "If you want a final panorama, choose a nearby town viewpoint only when luggage is already organized and the return walk is predictable."] },
  "kayseri-urgup": { heading: "Keep the final Urgup plan close to town before ASR", paragraphs: ["The longer ASR road makes Urgup\u2019s center a better last-hour choice than the Three Beauties or a distant valley stop. Breakfast, coffee, shopping or a short Temenni Hill walk can be abandoned quickly if the pickup changes.", "A private departure removes other hotel collections, but it does not change the need for airline check-in and the longer Kayseri road."] },
  "nevsehir-urgup": { heading: "Using spare time in Urgup before a NAV departure", paragraphs: ["With NAV, the road is shorter than ASR, yet the old-town hotel approach and airport procedures still need a buffer. Keep the last activity around central Urgup or Temenni Hill rather than adding a stop that requires another vehicle.", "If the airline changes the departure, stay reachable near the hotel until the new pickup is confirmed."] },
  "kayseri-uchisar": { heading: "Uchisar Castle views are easy to enjoy\u2014Pigeon Valley is harder to time before ASR", paragraphs: ["The castle area can work for a final short walk because it is close to many Uchisar hotels. A Pigeon Valley hike is different: it is not the right activity to squeeze in before the longer ASR road unless you have a large, separately planned margin.", "Be back at the reachable hotel or roadside meeting point with luggage before the confirmed shuttle window."] },
  "nevsehir-uchisar": { heading: "Do not spend the NAV distance advantage on a risky valley walk", paragraphs: ["NAV is close to Uchisar, but the safest final plan is still around the castle, a cafe or the hotel terrace. Pigeon Valley can take longer than expected and may leave you away from luggage when the vehicle arrives.", "The short road should make the airport day calmer, not tighter."] },
  "kayseri-avanos": { heading: "A final Avanos pottery or riverside stop can work if it stays local", paragraphs: ["Before the longer ASR departure, Avanos offers controllable spare-time options along the Kizilirmak and around central pottery workshops. Choose something within easy return distance of the hotel and avoid committing to an excursion toward Zelve or another town.", "Confirm which side of the river the pickup uses before leaving the hotel area."] },
  "nevsehir-avanos": { heading: "Riverfront time before NAV is easier to control than another Cappadocia excursion", paragraphs: ["A short walk beside the Kizilirmak or a nearby pottery stop can fit before a late NAV flight when luggage is already stored and pickup is confirmed. A second transfer to another attraction adds unnecessary risk to an otherwise short airport day.", "Return to the exact hotel or agreed roadside point before the collection window."] },
  "kayseri-ortahisar": { heading: "Ortahisar\u2019s castle streets suit a quiet final hour before ASR", paragraphs: ["The village is compact enough for a cafe or short walk around the castle area before a late flight, but the longer ASR road means the final plan should remain close to luggage. A valley outing is harder to end predictably.", "If the hotel uses a roadside meeting point, move luggage there before pickup rather than waiting for the vehicle to negotiate the old lane."] },
  "nevsehir-ortahisar": { heading: "A calm Ortahisar departure works best when the final activity stays in the village", paragraphs: ["With NAV, the road is moderate, so a short castle-area walk or cafe can be reasonable before pickup. Keep the plan inside Ortahisar and stay reachable if the airline or shuttle schedule changes.", "The benefit of the shorter airport side is a less stressful departure, not a reason to add another distant stop."] },
  "kayseri-cavusin": { heading: "Rose Valley is for a planned walk, not for filling time before ASR", paragraphs: ["Cavusin sits beside excellent valley routes, but those routes are exactly what should be avoided close to a Kayseri pickup. Trail timing, sunset and the longer ASR road do not combine well with a fixed airport deadline.", "Use the old village, hotel area or a nearby cafe for spare time and stay close to the agreed pickup point."] },
  "nevsehir-cavusin": { heading: "Even with NAV nearby, leave Red and Rose Valley out of the final pickup window", paragraphs: ["The shorter NAV road can make departure day feel relaxed, but a valley walk is still difficult to stop on command. Keep the final hours around Cavusin\u2019s village and hotel area so luggage and WhatsApp contact remain close.", "If you want a sunset valley visit, plan it on a non-flight day rather than relying on a tight return before the airport vehicle."] },
};
...
function arrivalPage(airportKey: 'kayseri' | 'nevsehir', townKey: keyof typeof towns): SeoPage {
  ...
  const sections: ContentSection[] = airportKey === 'kayseri' ? [
    ...
    { heading: routeLocalArrival[routeKey].heading, paragraphs: routeLocalArrival[routeKey].paragraphs },
  ...
  return {
    ...
    secondaryKeywords: [
      `${airportKey} airport to ${townKey}`,
      `${airportKey} to ${townKey}`,
      `${airportKey} to ${townKey} transfer`,
      `${airportKey} airport to ${townKey} shuttle`,
      `${a.code.toLowerCase()} to ${townKey}`,
      `transfer from ${airportKey} airport to ${townKey}`,
    ],
...
function returnPage(airportKey: 'kayseri' | 'nevsehir', townKey: keyof typeof towns): SeoPage {
  ...
  const sections: ContentSection[] = airportKey === 'kayseri' ? [
    ...
    { heading: `${t.name} hotels we recognize when arranging an ASR pickup`, paragraphs: [`The accommodation names below are included to reduce location ambiguity for a ${t.name} → ASR pickup; they are not a ranking or a claim that every vehicle can wait at every doorway. If your property is not listed, enter its complete reservation name and town in the booking form.`], bullets: [...p.hotels] },
    { heading: heads[3], paragraphs: [edit.spare, departureExtra[routeKey]], bullets: [...localLandmarks] },
    { heading: routeLocalReturn[routeKey].heading, paragraphs: routeLocalReturn[routeKey].paragraphs },
    ...
    { heading: `${t.name} accommodation names for NAV hotel pickup`, paragraphs: [`These accommodation names help distinguish real ${t.name} pickup locations when a guest books a hotel-to-NAV transfer. They are not a hotel ranking. If your accommodation is not listed, send the full property name and exact town so the practical pickup point can still be confirmed.`], bullets: [...p.hotels] },
  ...
  return {
    ...
    secondaryKeywords: [
      `${townKey} to ${airportKey} airport`,
      `${townKey} to ${a.name.toLowerCase()}`,
      `${townKey} to ${a.code.toLowerCase()}`,
      `transfer from ${townKey} to ${airportKey} airport`,
      `${townKey} hotel to ${airportKey} airport shuttle`,
      `${townKey} hotel to ${a.code.toLowerCase()} shuttle`,
    ],
...
function destinationHub(townKey: keyof typeof towns): SeoPage {
  ...
  return {
    ...
    primaryKeyword: `${t.name.toLowerCase()} airport transfer`, secondaryKeywords: [
      `${townKey} airport shuttle`,
      `${townKey} transfer`,
      `${townKey} airport`,
      `cappadocia ${townKey} shuttle`,
      `cappadocia airport to ${townKey}`,
      `airport transfer to ${townKey}`,
    ],
...
function airportHub(airportKey: 'kayseri' | 'nevsehir'): SeoPage {
  ...
  return {
    slug:`${airportKey}-airport-transfer`, title:`${a.name} Transfer to Cappadocia | Shuttle & Private`, description:`${a.name} (${a.code}) transfer to Goreme, Urgup, Uchisar, Avanos, Ortahisar and Cavusin. €15 shuttle, Vito €${a.vito}, Sprinter €${a.sprinter}.`, primaryKeyword:`${a.name.toLowerCase()} transfer`, secondaryKeywords:[
      `${a.code.toLowerCase()} transfer`,
      `${airportKey} airport private transfer`,
      `${airportKey} airport hotel transfer`,
      ...(airportKey==='nevsehir'
        ? ['nevsehir airport','airport nevsehir']
        : ['kayseri airport','turkey kayseri airport'])
    ], eyebrow:`${a.code} airport hub`, h1:`${a.name} Transfer to Cappadocia`, lead:`Use the ${a.code} hub to choose the exact hotel town, compare shuttle and private prices, and plan both airport arrival and hotel-to-airport departure.`,
    sections:[
...
function toCappadocia(airportKey:'kayseri'|'nevsehir'):SeoPage{
 const a=airports[airportKey]; const city=airportKey==='kayseri'?'Kayseri':'Nevsehir'; return {slug:`${airportKey}-to-cappadocia-transfer`,title:`${city} to Cappadocia Transfer | Airport Shuttle & Private`,description:`${city} to Cappadocia transfer from ${a.code}: €15 shuttle plus private Vito/Sprinter to Goreme, Urgup, Uchisar, Avanos, Ortahisar and Cavusin.`,primaryKeyword:`${city.toLowerCase()} to cappadocia transfer`,secondaryKeywords:[
      `${city.toLowerCase()} to cappadocia`,
      `${city.toLowerCase()} to cappadocia turkey`,
      `shuttle ${city.toLowerCase()} cappadocia`,
      ...(airportKey==='nevsehir'
        ? ['nevsehir to cappadocia','nevsehir to cappadocia turkey','nevsehir airport to cappadocia','nevsehir airport to cappadocia turkey']
        : ['kayseri to cappadocia','kayseri to cappadocia turkey','kayseri airport to cappadocia','kayseri airport to cappadocia turkey'])
    ],eyebrow:`${city} → Cappadocia`,h1:`${city} to Cappadocia Transfer`,lead:`A ${city} to Cappadocia airport transfer normally starts at ${a.fullName} (${a.code}) and finishes at a specific hotel town. Choose the actual town first so the distance, road estimate and arrival plan match the real trip.`,sections:[
 {heading:`What “${city} to Cappadocia” means for an airport passenger`,paragraphs:[`Cappadocia is a region, not one hotel district. A guest landing at ${a.code} may be staying in Goreme, Urgup, Uchisar, Avanos, Ortahisar or Cavusin. Those routes share the airport but do not share the same distance, hotel access or local arrival experience.`, airportKey==='kayseri' ? 'Searches such as **Kayseri Airport to Cappadocia**, **Kayseri to Cappadocia** and **Kayseri Airport to Cappadocia Turkey** normally describe the same first decision: which Cappadocia town and hotel is the real destination after ASR. This hub keeps those broad searches together, then sends the traveler to the exact town route.' : 'Searches such as **Nevsehir Airport to Cappadocia**, **Nevsehir to Cappadocia** and **Nevsehir Airport to Cappadocia Turkey** normally describe the same first decision: which Cappadocia town and hotel is the real destination after NAV. This hub keeps those broad searches together, then sends the traveler to the exact town route.', `Use this page as a hub, then open the exact destination rather than relying on a generic ${city}-Cappadocia estimate.`]},
